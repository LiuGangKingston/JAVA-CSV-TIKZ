...
// Specific calculation to generate CSV files
    ...
    int i, j, k, totallines=10, startingline=1;
    ...
    try {
         FileWriter bfile = new FileWriter("iterated.alldata.csv");
         bfile.write("totallines,i,refractiveindex,bigradius,a,b,z,anglez,c,"+
         ...
         System.out.println("An error occurred when working on the file iterated.alldata.csv, then stopped.");
         e.printStackTrace();
         System.exit(-9);
    }
